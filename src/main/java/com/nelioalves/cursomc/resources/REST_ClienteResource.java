...
// ============================= METODO GET: faz uma busca get/find no BD por uma instância da entidade que já existe no BD ======================================= 
	...
	public ResponseEntity<List<DTO_ClienteEntity_nome_email>> metodoREST_findAllCliente() throws Exception {
		List<ClienteEntity> var_list = null;
		try {
			var_list = var_serviceCliente.metodoService_findAllCliente();
		}
		catch (Exception e) {
			throw new Exception("ERRO_PADRAO#0039@Exception: "+e.getMessage());
		}
	...
	public ResponseEntity<Page<DTO_ClienteEntity_nome_email>> metodoREST_findPageCliente(
		...
		Page<ClienteEntity> var_list = null;
		try {
			var_list = var_serviceCliente.metodoService_findPageCliente(var_NumPage, var_LinesPerPage, var_orderBy, var_directionOrderBy);
		}
		catch (Exception e) {
			throw new Exception("ERRO_PADRAO#0040@Exception: "+e.getMessage());
		}
...
// ============================= METODO POST: faz um "insert" de nova instância da entidade no BD ================================================================= 
	...
	public ResponseEntity<Void> metodoREST_insertCliente(@Valid @RequestBody DTO_ClienteEntity_Completo var_objDTO) throws Exception {
		...
		try {
			...
			throw new Exception("ERRO_PADRAO#0041@Exception: "+e.getMessage());
		}
...
// ============================= METODO PUT: faz um "update" no BD em uma instância da entidade que já existe no BD ============================================== 
	...
	public ResponseEntity<Void> metodoREST_updateCliente(@Valid @RequestBody DTO_ClienteEntity_nome_email var_objDTO, @PathVariable Integer param_Id) throws Exception {
		...
		try {
			...
			throw new Exception("ERRO_PADRAO#0042@Exception: "+e.getMessage());
		}
...
// ============================= METODO DELETE: faz um "delete" no BD em uma instância da entidade que já existe no BD ======================================= 
	...
	public ResponseEntity<Void> metodoREST_deleteCliente(@PathVariable Integer param_Id) throws Exception {
		try {
			...
			throw new Exception("ERRO_PADRAO#0043@Exception: "+e.getMessage());
		}
		return ResponseEntity.noContent().build();
	}
// ============================= o METODO POST abaixo processa o endpoint "/clientes/picture que será para enviar arq ao Amazon S3 =========================== 
	...
	public ResponseEntity<Void> metodoREST_uploadProfilePictureToAmazonS3(@RequestParam(name="file") MultipartFile var_multipartFile) throws Exception {
		URI var_uri = null;
		try {
			var_uri = var_serviceCliente.metodoService_uploadProfilePictureService(var_multipartFile);
		}
		catch (Exception e) {
			throw new Exception("ERRO_PADRAO#0044@Exception: "+e.getMessage());
		}
		return ResponseEntity.created(var_uri).build();
	}
}
